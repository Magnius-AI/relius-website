...
// Helper: Fire Google Ads conversion event
function fireGoogleAdsConversion(sendTo: string, value: number, currency: string) {
...
export const analytics = {
    ...
    // Track CTA clicks with real-time notification and Google Ads conversion
    trackCTAClick: (ctaName: string, destination?: string) => {
      ...
      // 2. Fire Google Ads conversion for signup CTAs
      if (ctaName.includes("get_started_free") || ctaName.includes("free_trial")) {
              fireGoogleAdsConversion(GOOGLE_ADS_SIGNUP_SEND_TO, 1.0, "USD");
      }
