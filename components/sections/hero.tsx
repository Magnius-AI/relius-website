      ...
      <div className="container-width relative">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-balance text-5xl font-bold tracking-tight text-slate-950 md:text-6xl lg:text-7xl">
            Keep people, giving, and weekly ministry work in one place.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-600 sm:text-xl">
            Relius keeps member records, events, giving, and follow-up together. AI tools for sermon prep, messages, and care are available when your team needs them.
          </p>
          ...
          <div className="mt-9 flex flex-col items-center">
            ...
            <p className="mt-4 text-sm text-slate-500">Free plan. No credit card. No member limit.</p>
          </div>
