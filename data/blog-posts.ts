    ...
    content: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "paragraph", text: "Relius uses a simple, all-inclusive tiered model. **Starter plan is $49/month**, **Growth plan is $99/month**, **AI Pro plan is $149/month**, and **Enterprise is $249/month**. Every tier includes unlimited members --no penalizing churches for growth. Every feature in your tier is included: giving, check-ins, groups, pastoral care, communications, and AI tools at higher tiers. No app bundles to calculate, no surprises when you grow." },
          { type: "stat", value: "$99/mo", label: "Relius Growth for a church of 800 --vs. $180-220/mo on Planning Center for equivalent features", source: "Based on Planning Center published pricing, 2025" },
