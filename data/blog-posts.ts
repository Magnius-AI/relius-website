...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Church tax season checklist: payroll forms, giving statements, and CHMS workflows that keep you audit-ready",
    excerpt: "Tax season for churches is two seasons at once -- staff payroll compliance and donor substantiation. This checklist covers what to send, what to file, what to document, and how to build a repeatable workflow so January never feels like a scramble again.",
    author: "Felix Tang",
    role: "Relius Cofounder",
    date: "2026-02-10",
    readTime: "12 min",
