          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                asChild
              >
                <Link href={getContactUrlForMigration("planning-center")}>
                  ...
                  <div key={dataType} className="flex items-start gap-3 bg-white border border-slate-200 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        {dataType === "People" && "Member profiles, contact info, family relationships, custom fields"}
                        {dataType === "Donations" && "Full giving history, donation amounts, dates, and fund designations"}
                      </p>
                    </div>
                  </div>
                ))}
