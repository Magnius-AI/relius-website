...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-relius-2026.png", width: 1200, height: 630, alt: "Switch from Tithe.ly to Relius" }],
  },
  twitter: {
          ...
          <div className="max-w-4xl">
            <div className="flex flex-wrap gap-3 mb-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-medium">
                ...
                Average migration time: 3-4 hours
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                asChild
              >
                <Link href={getContactUrlForMigration("tithely")}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-slate-600 mb-6">
                Tithe.ly supports more data types than most platforms, and we import all of them:
              </p>
                  ...
                  <div key={dataType} className="flex items-start gap-3 bg-white border border-slate-200 rounded-lg p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        {dataType === "People" && "Member profiles, contact info, family relationships"}
                        {dataType === "Donations" && "Full giving history, recurring gifts, fund designations"}
                        {dataType === "Tags" && "All your tags and segments transfer over"}
                        {dataType === "Attendance" && "Check-in history and attendance records"}
                        {dataType === "Newsletter" && "Newsletter subscriber lists and preferences"}
                      </p>
                    </div>
                  </div>
                ))}
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-slate-600">
                Tithe.ly supports multiple export types. Follow these steps for each data type you want to migrate:
              </p>
            </div>
