...
const platform = getMigrationPlatform("pushpay")!;

export const metadata: Metadata = {
  title: MIGRATION_PAGE_META["pushpay"].title,
  description: MIGRATION_PAGE_META["pushpay"].description,
  keywords: MIGRATION_PAGE_META["pushpay"].keywords,
  alternates: {
    canonical: "https://relius.ai/switch/pushpay/",
  },
  openGraph: {
    title: "Pushpay Alternative 2026 — Free Church Giving & Management | Relius",
    description:
      "Looking for a Pushpay alternative? Relius offers free online giving plus complete church management with AI-powered tools. Migrate your data easily.",
    url: "https://relius.ai/switch/pushpay/",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "Switch from Pushpay to Relius",
      },
    ],
  },
  twitter: {
    ...
    title: "Pushpay Alternative 2026 — Free Church Giving & Management | Relius",
    description:
      "Looking for a Pushpay alternative? Relius offers free online giving plus complete church management with AI tools. Start free today.",
  },
};

export default function PushpayMigrationPage() {
  return (
    <main className="pt-24">
      <BreadcrumbSchema
        items={[
          ...
          { name: "Pushpay", url: "https://relius.ai/switch/pushpay/" },
        ]}
      />
      <FAQSchema
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                asChild
              >
                <Link href={getContactUrlForMigration("pushpay")}>
              ...
              <Button
                ...
                asChild
              >
                <Link href="#comparison">See Feature Comparison</Link>
              </Button>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        {dataType === "People" &&
                          "Member profiles, contact info, family relationships, attendance history"}
                        {dataType === "Donations" &&
                          "Complete contribution records, fund allocations, giving statements"}
                      </p>
                    </div>
                  </div>
                ))}
      ...
      <section
        id="comparison"
        className="py-16 px-6 lg:px-8 bg-white scroll-mt-24"
      >
        <div className="container-width">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-slate-600">
                Follow these steps to download your data, then upload it to
                Relius
              </p>
            </div>
      ...
      <section className="py-16 px-6 lg:px-8 bg-slate-50">
        <div className="container-width">
          <div className="max-w-3xl mx-auto">
            ...
            <Accordion>
              {[...platform.faqs, ...commonMigrationFAQs.slice(0, 3)].map(
                (faq, index) => (
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          <div className="rounded-2xl border border-slate-200 bg-white px-8 py-12 text-center shadow-xl sm:px-16 sm:py-16">
            ...
            <p className="text-lg text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Get started free and bring your church data with you. Our team is
              here to help.
            </p>
